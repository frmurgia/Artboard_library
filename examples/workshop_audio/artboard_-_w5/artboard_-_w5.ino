/*
  ...
  Descrizione: waveform + ottava completa + inviluppo (Attack and Release)+filtro
...
AudioFilterStateVariable filter3; //xy=986.75,839
AudioFilterStateVariable filter1; //xy=989.7500114440918,357.00001525878906
AudioMixer4              mixer5;         //xy=1173,533
AudioOutputAnalogStereo  dacs0;          //xy=1512.9999656677246,528.0000019073486
...
AudioConnection          patchCord41(filter3, 0, mixer5, 2);
AudioConnection          patchCord42(filter1, 0, mixer5, 0);
AudioConnection          patchCord43(mixer5, 0, dacs0, 0);
AudioConnection          patchCord44(mixer5, 0, dacs0, 1);
